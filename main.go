...
// @title MyGram API
// @version 1.0
// @description Aplikasi bernama MyGram sebagai aplikasi yang dapat menyimpan foto maupun membuat comment untuk foto orang lain. Secara sederhana, aplikasi ini adalah platform media sosial untuk berbagi momen foto.

// @termOfService http://swagger.io/terms/
// @contact.name ramadhan
// @contact.email ramadhanssw.public@gmail.com
